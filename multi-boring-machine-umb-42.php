               ...
               <div class="single-slide-item-table">
                  <div class="single-slide-item-table-cell">
                     <div class="container">
                        <div class="row">
                           <div class="col-md-12">
                              <h2 style="text-transform:capitalize">Multi-Boring UMB 42</span></h2>
   ...
   <div class="container">
      <div class="row">
         <div class="col-md-12 about-heading">
            <h2 style=""><span class="red-color">Two Row Multi-Boring </span><span class="blue-color"> Machine</span></h2>
...
<div class="home-aboutus-wrapper detail-page">
   <div class="container">
      <div class="row">
         ...
         <div class="col-md-6">
            <div class="about-text">
               <h3>Tilting Drilling Head </h3>
               <hr/>
               <ul class="list">
                  <li>Can do accurate hole on surface as well as on edge of board.</li>
                  <li>Tilting drilling head can move on 90</li>
               </ul>
            </div>
         </div>
      </div>
...
<div class="home-aboutus-wrapper detail-page">
   <div class="container">
      <div class="row">
         <div class="col-md-6">
            <div class="about-text">
               <h3>Vertical Boring Head </h3>
               <hr/>
               <ul class="list">
                  <li>21 drilling bits at 32mm distance.</li>
               </ul>
            </div>
         </div>
         <div class="col-md-6 text-center">
