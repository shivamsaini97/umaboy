          ...
          <div class="single-slide-item-table">
            <div class="single-slide-item-table-cell">
              <div class="container">
                <div class="row">
                  <div class="col-md-12">
                    <h2 style="text-transform:capitalize"> High Speed Feeder UF004</span></h2>
...
<div class="home-aboutus-wrapper detail-page">
  <div class="container">
    <div class="row">
	 <div class="col-md-6 text-center">
		...
		<img src="images/HIGH_SPEED_FEEDER_UF004.png" alt=""> </div>
 ...
 1 HP (0.75Kw) 3 phase only <br/><br/>
<strong>Variable speed</strong> : &nbsp;&nbsp; (50Hz) 2 17 M/min<br/><br/>
