...
<div class="home-aboutus-wrapper about-us-section home-product">
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				...
				<p>
					...
					Uttar Pradesh, Bihar, Jharkhand and Uttarakhand.<br /><br />
		...
		<div class="about-heading">
			...
			<div class="col-sm-3">
				<div class="counter">
					...
					<div class="number animateNumber" data-num="35"><span>+</span></div>
			...
			<div class="col-sm-3">
				<div class="counter">
					<div class="counter-icon-box"></div>
					<div class="number animateNumber" data-num="3"><span>+</span></div>
			...
			<div class="col-sm-3">
				<div class="counter">
					<div class="counter-icon-box"></div>
					<div class="number animateNumber" data-num="4"><span>+</span></div>
					<p>Showroom in India</p>
				</div>
			</div>
			<div class="col-sm-3">
				<div class="counter">
					<div class="counter-icon-box"></div>
					<div class="number animateNumber" data-num="15"><span>+</span></div>
			...
			<div class="col-md-7">
				<div class="about-text">
					...
					<p>
						...
						stories of those who make it every day with competence and dedication. A new way to discover the
						company, the thought of the driver, the technological innovation that gives prestige, the
