            ...
            <div class="single-slide-item-table">
              <div class="single-slide-item-table-cell">
                <div class="container">
                  <div class="row">
                    <div class="col-md-12">
                      <h2 style="text-transform:capitalize">Multi-Boring UMB 63</span></h2>
  ...
  <div class="home-aboutus-wrapper detail-page">
      <div class="container">
          ...
          <div class="col-md-12 about-heading">
            <h2 style="margin-bottom: 60px;"><span class="red-color">Three Line Multi-Boring </span><span class="blue-color"> Machine</span></h2>
      ...
      <div class="container">
        ...
        <div class="col-md-12 text-center">
          <div class="col-md-6 ">
            ...
            <img src="images/Multi-Boring-63.png" alt=""> </div>
