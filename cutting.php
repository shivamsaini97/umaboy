          ...
          <div class="single-slide-item-table">
            <div class="single-slide-item-table-cell">
              <div class="container">
                <div class="row">
                  <div class="col-md-12">
                    <h2 style="text-transform:capitalize">Cutting Technologies</span></h2>
      ...
      <div class="col-lg-4 col-md-6 col-sm-6">
        <div class="single-blog-section"> 
          ...
          <div class="blog-info">
            ...
            <button class="btn btn-default unicod-btn-black" type="submit"><a href="panel-saw-a-detail.php">read more</a></button>
          </div>
        </div>
      </div>
      <div class="col-lg-4 col-md-6 col-sm-6">
        <div class="single-blog-section"> 
          <a href="panel-saw-ups-3200b.php"><img src="images/PANEL_SAW_UPS_3200A.png" alt=""></a>
          <div class="blog-info">
            
            <div class="content">
              <a href="panel-saw-ups-3200b.php"><h3>Panel Saw UPS 3200B</h3></a>
              <div class="collor-bottom-two"></div>
            </div>
          
            <button class="btn btn-default unicod-btn-black" type="submit"><a href="panel-saw-ups-3200b.php">read more</a></button>
          </div>
        </div>
      </div>
      <div class="col-lg-4 col-md-6 col-sm-6">
        <div class="single-blog-section"> 
          ...
          <div class="blog-info">
            ...
            <button class="btn btn-default unicod-btn-black" type="submit"><a href="panel-saw-ap-detail.php">read more</a></button>
          </div>
        </div>
      </div>
      <div class="col-lg-4 col-md-6 col-sm-6">
        <div class="single-blog-section"> 
          <a href="panel-saw-ups-3200adplus.php"><img src="images/PANEL_SAW_UPS_3200A+.png" alt=""></a>
          <div class="blog-info">
            
            <div class="content">
              <a href="panel-saw-ups-3200adplus.php"><h3>Panel Saw UPS 3200A++</h3></a>
              <div class="collor-bottom-two"></div>
            </div>
          
            <button class="btn btn-default unicod-btn-black" type="submit"><a href="panel-saw-ups-3200adplus.php">read more</a></button>
          </div>
        </div>
      </div>
      <div class="col-lg-4 col-md-6 col-sm-6">
        <div class="single-blog-section"> 
          <a href="beam-saw-auto-detail.php"><img src="images/beam-saw-auo.png" alt=""></a>
          <div class="blog-info">
